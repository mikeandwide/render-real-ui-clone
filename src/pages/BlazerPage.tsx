            ...
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div key={item} className="flex flex-col items-center">
                <div className="bg-[#f8f8f8] w-full aspect-[0.8] mb-4 flex items-center justify-center">
                  <img 
                    src={`https://cdn.builder.io/api/v1/image/assets/TEMP/96df9866aa9438ef7e8024553e30fe60acce036b?placeholderIfAbsent=true`}
                    alt={`Blazer ${item}`}
                    className="h-4/5 object-contain"
                  />
                </div>
                <h3 className="text-sm font-bold text-center">BLACK STRUCTURE WORSTED WOOL BLAZER</h3>
                <p className="text-sm mt-2">$ 129</p>
              </div>
            ))}
          </div>
        </div>
